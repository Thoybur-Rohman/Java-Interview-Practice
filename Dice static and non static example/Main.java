public class Main {
    ...
    public static void main(String[] args) {
        ...
        //because it is a static you cannot access this with an instance but the class itself

        // myFirstDice.changeNumSidesOfDice(10);
        //because it is a static you cannot access this with an instance but the class itself

        // Dice.roll();
        //An instance must call it so an instace must be made first
        // Dice.faceValue;
